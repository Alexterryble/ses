...
<div class="print-hidden ui-card" id="ui-prestatario">
  ...
  <div class="ui-row">
    ...
    <div class="ui-field">
      ...
      <select id="tipo_contrato" class="ui-input">
        <option value="40" selected>PERSONAL 40 ORDINARIO</option>
        <option value="10">PERSONAL 10 ORDINARIO</option>
      </select>
    </div>
  </div>
  ...
  <div class="ui-actions">
    ...
    <div class="ui-actions__right">
      ...
      <button id="btn_generar" type="button" class="btn btn--ghost">
        Generar Formato
      </button>

      <button id="btn_guardar" type="button" onclick="guardarContrato()">
        Guardar Formato
      </button>
...
<p>
  ...
  vida), se devengará un interés ordinario del <strong>9.74% + IVA mensual</strong> durante
...
<ul>
  ...
  <li>Interés ordinario: <strong>9.74% + IVA</strong> sobre el monto financiado por
...
<script src="/js/contrato/contrato2.js"></script>
